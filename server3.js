...
//           sameSite: 'strict',
//         }).json({ success: 'true', token, id: user.id, threadId: user.threadId });
//       }
//     );
//   } catch (err) {
//     console.error(err.message);
...
//         // No conversion needed, just pass the file path
//       }
...
//       attachments.push({ file_id: createdFile.id, tools: [{ type: "file_search" }] });
